...
@given(arr=st.lists(st.integers()), threads_cnt=st.integers(min_value=1, max_value=32))
...
@settings(max_examples=1000)
@given(arr=st.lists(st.integers()), threads_cnt=st.integers(min_value=1, max_value=4))
